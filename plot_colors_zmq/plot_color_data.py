'''
Connect to a zeromq publisher socket sending
color sensor data and plot it with matplotlib.
'''
...
parser.add_argument(
    '--buffer', default=5, type=int,
    help='How many values to receive before updating the plot'
)
parser.add_argument(
    '--points', default=250, type=int,
    help='How many color values to show in the plot'
)
